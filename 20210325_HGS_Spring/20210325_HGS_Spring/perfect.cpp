...
HRESULT CPerfect::Init(void)
{
	...
	{
		// 数字のメモリ確保
		m_pPerfect[nCount] = CNumber2d::Create(D3DXVECTOR3(PERFECT_POS_X - nCount*RANKING_INTERVAL_X,
			PERFECT_POS_Y + RANKING_INTERVAL_Y, 0.0f),
			D3DXVECTOR3(PERFECT_SIZE_X, PERFECT_SIZE_Y, 0.0f));
